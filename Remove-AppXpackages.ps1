...
$WhiteListOnDemand = "NetFX3|Tools.Graphics.DirectX|Tools.DeveloperMode.Core|Language|Browser.InternetExplorer|Media.WindowsMediaPlayer|Windows.MSPaint|Windows.Notepad|Windows.PowerShell.ISE|Windows.WordPad|Client.ShellComponents|App.StepsRecorder"
